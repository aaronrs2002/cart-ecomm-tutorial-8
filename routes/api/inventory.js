...
router.get("/:itemName", (req, res) => {
    let sql = `SELECT * FROM inventory WHERE itemName = '${req.params.itemName}'`;
...
router.put("/update-order-status", checkToken, (req, res) => {
    let sql = `UPDATE inventory SET status = '${req.body.status}' WHERE userTimestamp = '${req.body.userTimestamp}'`;
